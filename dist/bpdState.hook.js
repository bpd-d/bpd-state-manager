...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createStateManager", function() { return createStateManager; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "performStateAction", function() { return performStateAction; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "subscribeToState", function() { return subscribeToState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "unsubscribeFromState", function() { return unsubscribeFromState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "undoState", function() { return undoState; });
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _helpers_errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
/* harmony import */ var _helpers_functions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(0);



let bdpStateManagerFactory = undefined;
function getGlobaStateManager() {
    if (!Object(_helpers_functions__WEBPACK_IMPORTED_MODULE_2__[/* is */ "b"])(bdpStateManagerFactory)) {
        throw new _helpers_errors__WEBPACK_IMPORTED_MODULE_1__[/* StateManagerShorthandError */ "e"]("createState", "Manager must be initialized first with createStateManager");
    }
    return bdpStateManagerFactory;
}
function createStateManager(config) {
    if (Object(_helpers_functions__WEBPACK_IMPORTED_MODULE_2__[/* is */ "b"])(bdpStateManagerFactory)) {
        throw new _helpers_errors__WEBPACK_IMPORTED_MODULE_1__[/* StateManagerShorthandError */ "e"]("createStateManager", "Manager was already initialized");
    }
    bdpStateManagerFactory = new _core__WEBPACK_IMPORTED_MODULE_0__["BpdStateManagerFactory"](config);
}
function createState(name, initialValue, mutationHandler, config) {
...
function performStateAction(name, action, callback) {
    getGlobaStateManager().perform(name, action, callback);
}
function subscribeToState(name, callback) {
    return getGlobaStateManager().subscribe(name, callback);
}
function unsubscribeFromState(name, id) {
...
//# sourceMappingURL=bpdState.hook.js.map